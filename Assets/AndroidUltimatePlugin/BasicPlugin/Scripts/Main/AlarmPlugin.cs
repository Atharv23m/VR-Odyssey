...
public class AlarmPlugin : MonoBehaviour {
	...
	string channelID, string channelName){
		#if UNITY_ANDROID
		if(Application.platform == RuntimePlatform.Android){
			jo.CallStatic("setAlarm",requestCode,hour,minute,sec,amOrPm,alarmTile,alarmMessage,alarmTickerMessage,channelID,channelName);
		}else{
			AUP.Utils.Message(TAG,"warning: must run in actual android device");
		}
		#endif
	...
	string channelID, string channelName){
		#if UNITY_ANDROID
		if(Application.platform == RuntimePlatform.Android){
			jo.CallStatic("setExactAlarm",requestCode,hour,minute,sec,amOrPm,alarmTile,alarmMessage,alarmTickerMessage,channelID,channelName);
		}else{
			AUP.Utils.Message(TAG,"warning: must run in actual android device");
		}
		#endif
	...
	string channelID, string channelName){
		#if UNITY_ANDROID
		if(Application.platform == RuntimePlatform.Android){
			jo.CallStatic("setAlarmAfterDay",requestCode,day,hour,minute,sec,amOrPm,alarmTile,alarmMessage,alarmTickerMessage,channelID,channelName);
		}else{
			AUP.Utils.Message(TAG,"warning: must run in actual android device");
		}
		#endif
	...
	string channelID, string channelName){
		#if UNITY_ANDROID
		if(Application.platform == RuntimePlatform.Android){
			jo.CallStatic("setRepeatingAlarm",requestCode,hour,minute,sec,amOrPm,delay,alarmTile,alarmMessage,alarmTickerMessage,channelID,channelName);
		}else{
			AUP.Utils.Message(TAG,"warning: must run in actual android device");
		}
		#endif
	...
	string channelID, string channelName){
		#if UNITY_ANDROID
		if(Application.platform == RuntimePlatform.Android){
			jo.CallStatic("setInExactRepeatingAlarm",requestCode,hour,minute,sec,amOrPm,delay,alarmTile,alarmMessage,alarmTickerMessage,channelID,channelName);
		}else{
			AUP.Utils.Message(TAG,"warning: must run in actual android device");
		}
		#endif
	...
	string channelID, string channelName){
		#if UNITY_ANDROID
		if(Application.platform == RuntimePlatform.Android){
			jo.CallStatic("setInExactRepeatingAlarmElapseRealTimeWakeUp",requestCode,hour,minute,sec,amOrPm,delay,alarmTile,alarmMessage,alarmTickerMessage,channelID,channelName);
		}else{
			AUP.Utils.Message(TAG,"warning: must run in actual android device");
		}
		#endif
	...
	string channelID, string channelName){
		#if UNITY_ANDROID
		if(Application.platform == RuntimePlatform.Android){
			jo.CallStatic("setInExactPerDayRepeatingAlarm",requestCode,hour,minute,sec,amOrPm,alarmTile,alarmMessage,alarmTickerMessage,channelID,channelName);
		}else{
			AUP.Utils.Message(TAG,"warning: must run in actual android device");
		}
		#endif

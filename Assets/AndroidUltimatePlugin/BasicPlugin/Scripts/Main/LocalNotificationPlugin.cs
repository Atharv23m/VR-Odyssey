...
public class LocalNotificationPlugin : MonoBehaviour{
	...
	string channelID, string channelName ){
		#if UNITY_ANDROID
		if(Application.platform == RuntimePlatform.Android){
			jo.CallStatic("scheduleNotification",notificationTitle,notificationMessage,notificationTickerMessage,delay,enableVibrate,enableSound,requestCode,channelID,channelName);
		}else{
			AUP.Utils.Message(TAG,"warning: must run in actual android device");
		}
		#endif
	...
	/// <param name="enableVibrate">If set to <c>true</c> enable vibrate.</param>
	/// <param name="enableSound">If set to <c>true</c> enable sound.</param>
	public void ScheduleSpecificNotification(string notificationTitle,int requestCode,int hour, int minute, int sec,int amOrPm, string notificationMessage,string notificationTickerMessage,
	bool enableVibrate,bool enableSound,string channelID, string channelName ){
		#if UNITY_ANDROID
		if(Application.platform == RuntimePlatform.Android){
	...
	public void ScheduleAfterDay(string notificationTitle,int requestCode,
		...
		#if UNITY_ANDROID
		if(Application.platform == RuntimePlatform.Android){
			jo.CallStatic("scheduleAfterDay",notificationTitle,requestCode,day,hour,minute,sec,amOrPm,notificationMessage,notificationTickerMessage,enableVibrate,enableSound,channelID,channelName);
		}else{
			AUP.Utils.Message(TAG,"warning: must run in actual android device");
		}
		#endif
	...
	public void ScheduleShortTime(string notificationTitle,int requestCode,
		...
		#if UNITY_ANDROID
		if(Application.platform == RuntimePlatform.Android){
			jo.CallStatic("scheduleShortTime",notificationTitle,requestCode,day,hour,minute,sec,notificationMessage,notificationTickerMessage,
			enableVibrate,enableSound,channelID,channelName);
		}else{
			AUP.Utils.Message(TAG,"warning: must run in actual android device");
		}
		#endif
	...
	public void ScheduleLongTime(string notificationTitle,int requestCode,
		...
		#if UNITY_ANDROID
		if(Application.platform == RuntimePlatform.Android){
			jo.CallStatic("scheduleLongTime",notificationTitle,requestCode,year,month,week,day,hour,minute,sec,notificationMessage,notificationTickerMessage,
			enableVibrate,enableSound,channelID,channelName);
		}else{
			AUP.Utils.Message(TAG,"warning: must run in actual android device");
		}
